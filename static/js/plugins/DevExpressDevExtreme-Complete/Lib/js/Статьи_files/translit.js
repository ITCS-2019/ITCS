...
$(document).ready(function(){
	// Products
	setTranslit("product_description\\[2\\]\\[name\\]", "product_seo_url", false);
	// Info Articles
	setTranslit("information_description\\[2\\]\\[title\\]", "information_seo_url", false);
	// Categories
	setTranslit("category_description\\[2\\]\\[name\\]", "category_seo_url", false);
	// Manufacturer
	setTranslit("name", "manufacturer_seo_url", false);
});
